...
class TestBase(unittest.TestCase):
    ...
    def test_J_load_from_file(self):
        ...
        self.assertEqual(str(type(rectangles[0])), "<class 'models.rectangle.Rectangle'>")

    def test_K_load_from_file_no_file(self):
        '''Tests load_from_file() when file does not exist.'''
        try:
    ...
    def test_L_load_from_file_empty(self):
        '''Tests load_from_file() when file is empty.'''
        with open("Rectangle.json", "w") as f:
            pass
        rectangles = Rectangle.load_from_file()
        self.assertEqual(rectangles, [])

    def test_M_save_to_file_square(self):
        '''Tests save_to_file()'''
        s1 = Square(10, 7, 2)
        s2 = Square(1, 2, 3)
    ...
    def test_N_load_from_file_square(self):
        '''Tests load_from_file()'''
        s1 = Square(10, 7, 2)
        s2 = Square(1, 2, 3)
        Square.save_to_file([s1, s2])
        ...
        self.assertEqual(str(type(squares[0])), "<class 'models.square.Square'>")

    def test_O_load_from_file_square_no_file(self):
        '''Tests load_from_file() when file does not exist.'''
        try:
    ...
    def test_P_load_from_file_square_empty(self):
        '''Tests load_from_file() when file is empty.'''
